    ...
    <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
      ...
      <div className="flex w-full flex-col gap-3 xl:w-auto xl:min-w-[680px]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <FeedbackFilters designers={designers} value={designerId} onChange={setDesignerId} status={tab === "suggestions" ? suggestionStatus : undefined} onStatusChange={setSuggestionStatus} />
