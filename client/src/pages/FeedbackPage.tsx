  ...
  return <div className="space-y-4 p-4 md:space-y-8 md:p-8">
    <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
      <div className="max-w-md">
        <p className="text-sm font-medium uppercase tracking-wider text-blue-400">Client Experience</p>
        <h1 className="mt-1 text-2xl font-bold leading-tight text-white md:text-3xl">Client Feedback</h1>
        <p className="mt-2 text-slate-400">Track client reviews, testimonials and improvement suggestions.</p>
      </div>
